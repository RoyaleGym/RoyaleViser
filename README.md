...
<p align="center">
  <img alt="Tests on a clone at acd8c48, 2026-09-22: 162 passed, 4 skipped" src="https://img.shields.io/badge/tests_on_a_clone%2C_2026--09--22-162_passed%2C_4_skipped-2ea043?style=flat-square">
...
an empty folder. On a machine that has the recordings it is 165 passed, 1 skipped.
...
```
cd RoyaleViser && ..\.venv\Scripts\python -m pytest -q        # 162 passed, 4 skipped on a clone (2026-09-22, acd8c48)
...
run and the count is 165 passed, 1 skipped.
