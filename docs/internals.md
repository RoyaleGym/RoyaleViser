...
The suite has two correct results, and both are one command apart. Measured at acd8c48 on 2026-09-22, with `pytest --collect-only -q` collecting 166:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **162 passed, 4 skipped** |
| this machine, with the recordings | **165 passed, 1 skipped** |
