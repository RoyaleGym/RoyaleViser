...
The suite has two correct results, and both are one command apart. Measured at 447f18a on 2026-09-22, with `pytest --collect-only -q` collecting 173:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **169 passed, 4 skipped** |
| this machine, with the recordings | **172 passed, 1 skipped** |
