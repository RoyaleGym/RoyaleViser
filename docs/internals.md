...
The suite has two correct results, and both are one command apart. Measured at 6dad671 on 2026-09-23, with `pytest --collect-only -q` collecting 202:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **198 passed, 4 skipped** |
| this machine, with the recordings | **201 passed, 1 skipped** |
