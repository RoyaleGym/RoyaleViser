...
The suite has two correct results, and both are one command apart. Measured at eddee92 on 2026-09-22, with `pytest --collect-only -q` collecting 177:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **173 passed, 4 skipped** |
| this machine, with the recordings | **176 passed, 1 skipped** |
