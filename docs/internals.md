...
The suite has two correct results, and both are one command apart. Measured at 455d6f9 on 2026-09-22, with `pytest --collect-only -q` collecting 169:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **165 passed, 4 skipped** |
| this machine, with the recordings | **168 passed, 1 skipped** |
