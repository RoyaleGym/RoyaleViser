...
The suite has two correct results, and both are one command apart. Measured at 519b484 on 2026-09-22, with `pytest --collect-only -q` collecting 174:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **170 passed, 4 skipped** |
| this machine, with the recordings | **173 passed, 1 skipped** |
