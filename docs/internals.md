...
The suite has two correct results, and both are one command apart. Measured at 642527c on 2026-09-23, with `pytest --collect-only -q` collecting 197:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **193 passed, 4 skipped** |
| this machine, with the recordings | **196 passed, 1 skipped** |
