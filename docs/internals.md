...
The suite has two correct results, and both are one command apart. Measured at 1cb2300 on 2026-09-22, with `pytest --collect-only -q` collecting 165:

| Run | Result |
|---|---|
| a clone, `ROYALELIVE_REPORTS` pointed at an empty folder | **161 passed, 4 skipped** |
| this machine, with the recordings | **164 passed, 1 skipped** |
